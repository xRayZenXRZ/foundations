...
export const teams: Array<Team> = [
    ...
    {id : 5, name : "Pulsar", base : "Amérique du Sud", title : "Vers l'inconnu ", memberCount : 65, partners : [3]},
    {id : 6, name : "Kepler", base : "Océanie", title : "Ensemble au-delà", memberCount : 55, partners : []}
]